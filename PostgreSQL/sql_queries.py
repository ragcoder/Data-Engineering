...
songplay_table_create = ("""
    ...
    start_time timestamp NOT NULL, user_id varchar(18) NOT NULL, level varchar NOT NULL,
    song_id varchar(18), artist_id varchar(18), session_id int NOT NULL,
    location varchar NOT NULL, user_agent text NOT NULL);
""")

user_table_create = ("""
    CREATE TABLE IF NOT EXISTS users(user_id varchar(18) PRIMARY KEY,
...
song_table_create = ("""
    ...
    title text, artist_id varchar(18) NOT NULL, year int, duration numeric);
""")

artist_table_create = ("""
    CREATE TABLE IF NOT EXISTS artists (artist_id varchar(18) PRIMARY KEY,
    name varchar NOT NULL, location varchar, latitude numeric, longitude numeric);
""")
...
song_select = ("""
    SELECT s.song_id, a.artist_id FROM songs as s JOIN artists as a 
